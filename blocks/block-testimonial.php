 ...
 */
add_action('acf/init', 'lightseek_testimonial_block'); 
function lightseek_testimonial_block()
{
  ...
  if (function_exists('acf_register_block')) {
    ...
    acf_register_block(array(
      'name' => 'testimonial', 
      'title' => __('Single Testimonial Block'), 
      'description' => __('Adds a random testimonial.'), 
      'render_callback' => 'lightseek_testimonial_callback',
      'category' => 'lightseek-blocks',
      'icon' => 'editor-break', 
      'keywords' => array('testimonial', 'lightseek', 'iseek'), 
      'mode'              => 'auto', 
    ));
  }
}

function lightseek_testimonial_callback($block)
{
